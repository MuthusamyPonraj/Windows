...
namespace IEnumerableDemo
{
    public class PopulateCustomers
    {
        ...
        private static Customer ReadCustomer7()
        {
            Customer cust = new Customer("257-11-5895");
            cust.FirstName = "Hanna Moos";
            cust.LastName = "Steve";
            return cust;
        }
        private static Customer ReadCustomer8()
        {
            Customer cust = new Customer("250-17-8625");
            cust.FirstName = "Christina Berglund";
            cust.LastName = "Hanna Moos";
            return cust;
        }
        private static Customer ReadCustomer9()
        {
            Customer cust = new Customer("158-11-5635");
            cust.FirstName = "Thomas Hardy";
            cust.LastName = "Christina Berglund";
            return cust;
        }
        private static Customer ReadCustomer10()
        {
            Customer cust = new Customer("158-11-5635");
        ...
        private static Customer ReadCustomer11()
        {
            Customer cust = new Customer("758-14-5335");
            cust.FirstName = "Elizabeth Lincoln";
            cust.LastName = "Christina Berglund";
            return cust;
        }
        private static Customer ReadCustomer12()
        {
            Customer cust = new Customer("558-31-6635");
            cust.FirstName = "Patricio Simpson";
            cust.LastName = "Martín Sommer";
            return cust;
        }
        private static Customer ReadCustomer13()
        {
            Customer cust = new Customer("154-10-8635");
            cust.FirstName = "Aria Cruz";
            cust.LastName = "Sven Ottlieb";
            return cust;
        }
        private static Customer ReadCustomer14()
        {
            Customer cust = new Customer("168-11-5135");
            cust.FirstName = "Peter Franken";
            cust.LastName = "Christina Berglund";
            return cust;
        }
        private static Customer ReadCustomer15()
        {
            Customer cust = new Customer("188-01-3605");
