...
namespace NavigationDrawTile
{
    public partial class BigTile :Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString(this.HeaderText,header, new SolidBrush(Color.White), headertext);
            InitializeLabel(e);
            Drawlabeltext(e);
        }
        private void Drawlabeltext(PaintEventArgs e)
        {
            e.Graphics.DrawString(PostionText, new System.Drawing.Font(this.Font.FontFamily,10, FontStyle.Regular), new SolidBrush(Color.White), (float)m_Position.Bounds.Right + 2, (float)m_Position.Bounds.Y);
            e.Graphics.DrawString(OrganizatonText, new System.Drawing.Font(this.Font.FontFamily, 10, FontStyle.Regular), new SolidBrush(Color.White), (float)m_Position.Bounds.Right + 2, (float)m_Organization.Bounds.Y);
            e.Graphics.DrawString(DOBText, new System.Drawing.Font(this.Font.FontFamily, 10, FontStyle.Regular), new SolidBrush(Color.White), (float)m_Position.Bounds.Right + 2, (float)m_DOB.Bounds.Y);
            e.Graphics.DrawString(LocationText, new System.Drawing.Font(this.Font.FontFamily, 10, FontStyle.Regular), new SolidBrush(Color.White), (float)m_Position.Bounds.Right + 2, (float)m_Location.Bounds.Y);
        }
        ...
        internal void InitializeLabel(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("Postion", new System.Drawing.Font(this.Font.FontFamily, 10, FontStyle.Regular), new SolidBrush(Color.White), m_PositionLocation);
            e.Graphics.DrawString("Organizaton", new System.Drawing.Font(this.Font.FontFamily, 10, FontStyle.Regular), new SolidBrush(Color.White), m_OrganizationLocation);
            e.Graphics.DrawString("Date Of Birth", new System.Drawing.Font(this.Font.FontFamily, 10, FontStyle.Regular), new SolidBrush(Color.White), m_DOBLocation);
            e.Graphics.DrawString("Location", new System.Drawing.Font(this.Font.FontFamily, 10, FontStyle.Regular), new SolidBrush(Color.White), m_LocationLocation);
        }
        private void InitializeRichTextBox()
        {
            ...
            bottomdescription.ForeColor = Color.White;
