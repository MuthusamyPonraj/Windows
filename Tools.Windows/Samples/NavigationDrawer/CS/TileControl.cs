...
namespace NavigationDrawTile
{
    public partial class TileControl : Control
    {
        ...
        internal void InitializeLabel(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("Postion", this.Font, new SolidBrush(Color.Black), m_PositionLocation);
            e.Graphics.DrawString("Organizaton", this.Font, new SolidBrush(Color.Black), m_OrganizationLocation);
            e.Graphics.DrawString("Date Of Birth", this.Font, new SolidBrush(Color.Black), m_DOBLocation);
            e.Graphics.DrawString("Location", this.Font, new SolidBrush(Color.Black), m_LocationLocation);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString(this.HeaderText, new Font(this.Font.FontFamily, 11, FontStyle.Bold) , new SolidBrush(Color.White), headertext);
            InitializeLabel(e);
            Drawlabeltext(e);
        }
        ...
        {
            e.Graphics.DrawString(PostionText, this.Font, new SolidBrush(Color.Black), (float)m_Position.Bounds.Right + 2, (float)m_Position.Bounds.Y);
            e.Graphics.DrawString(OrganizatonText, this.Font, new SolidBrush(Color.Black), (float)m_Position.Bounds.Right + 2, (float)m_Organization.Bounds.Y);
            e.Graphics.DrawString(DOBText, this.Font, new SolidBrush(Color.Black), (float)m_Position.Bounds.Right + 2, (float)m_DOB.Bounds.Y);
            e.Graphics.DrawString(LocationText, this.Font, new SolidBrush(Color.Black), (float)m_Position.Bounds.Right + 2, (float)m_Location.Bounds.Y);
        }
    }
}
