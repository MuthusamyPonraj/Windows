...
namespace EditorCellDemo
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            new Syncfusion.Windows.Forms.Grid.GridColWidth(1, 103),
            new Syncfusion.Windows.Forms.Grid.GridColWidth(2, 103),
            new Syncfusion.Windows.Forms.Grid.GridColWidth(3, 103),
            new Syncfusion.Windows.Forms.Grid.GridColWidth(4, 103),
            new Syncfusion.Windows.Forms.Grid.GridColWidth(5, 103),
            new Syncfusion.Windows.Forms.Grid.GridColWidth(6, 103),
            new Syncfusion.Windows.Forms.Grid.GridColWidth(7, 103),
            new Syncfusion.Windows.Forms.Grid.GridColWidth(8, 103),
