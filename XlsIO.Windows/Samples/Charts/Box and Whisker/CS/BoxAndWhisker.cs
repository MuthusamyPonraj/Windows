...
{
    public class BoxAndWhisker : MetroForm
    {
        #region Constants
        ...
        {
            string fileName = "BoxAndWhiskerTemplate.xlsx";
            ...
            workbook.SaveAs("BoxAndWhisker_Chart.xlsx");
            workbook.Close();
            #endregion
            OpenOutput("BoxAndWhisker_Chart.xlsx");
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BoxAndWhisker));
            ...
            this.groupBox1.Text = "Box And Whisker";
            // 
            // groupBox2
            // 
    ...
    "nt.";
        ...
        static void Main()
        {
            ...
            Application.Run(new BoxAndWhisker());
        }
        #endregion           
    }
}
