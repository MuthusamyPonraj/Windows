...
{
    public class Treemap : MetroForm
    {
        #region Constants
        ...
        {
            string fileName = "TreemapTemplate.xlsx";
            ...
            workbook.SaveAs("Treemap_Chart.xlsx");
            workbook.Close();
            #endregion
            OpenOutput("Treemap_Chart.xlsx");
        }
