...
namespace Imports
{
    ...
    public class Program
    {
        ...
        private void InitializeTable(int rowCount, string predictedfield, string[] predictedCategories)
        {
            ...
            outputTable.ColumnNames[1] = "DieselFuelTypeProbability";
            outputTable.ColumnNames[2] = "GasFuelTypeProbability";
        ...
        public object GetDataObject(Table inputTable, int row)
        {
            var imports = new
            {
                ...
                engineLocation = inputTable[row, "engineLocation"],
                ...
                engineType = inputTable[row, "engineType"],
                numOfCylinders = inputTable[row, "numOfCylinders"],
                engineSize = inputTable[row, "engineSize"],
                fuelSystem = inputTable[row, "fuelSystem"],
