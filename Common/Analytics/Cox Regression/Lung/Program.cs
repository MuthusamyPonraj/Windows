...
namespace LungCoxRegression
{
    ...
    public class Program
    {
        ...
        public object GetDataObject(Table inputTable, int row)
        {
            var lung = new
            {
                inst = inputTable[row, "inst"],
                time = inputTable[row, "time"],
                status = inputTable[row, "status"],
                age = inputTable[row, "age"],
                sex = inputTable[row, "sex"],
                ph_ecog = inputTable[row, "ph_ecog"],
                ph_karno = inputTable[row, "ph_karno"],
                meal_cal =  inputTable[row, "meal_cal"],
                wt_loss =  inputTable[row, "wt_loss"],
            };
            return lung;
        }
