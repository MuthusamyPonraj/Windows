...
namespace GlassBinomialProbit
{
    ...
    public class Program
    {
        ...
        private void InitializeTable(int rowCount, string[] predictedCategories)
        {
            ...
            outputTable.ColumnNames[0] = "Predicted_WindowFloatGlassType";
            outputTable.ColumnNames[1] = "NonWindowFloatGlassTypeProbability";
            outputTable.ColumnNames[2] = "WindowFloatGlassTypeProbability";
