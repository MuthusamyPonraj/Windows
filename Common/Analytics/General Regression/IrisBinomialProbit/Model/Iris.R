...
# Frame the data 
versicolor = as.character(as.integer(iris$Species == 'versicolor'))
iris = cbind(iris[, 1:4], versicolor)
...
# Applying General Regression Model - probit function to predict versicolor
irisFormula = formula(versicolor ~ .)
iris_GLM = glm(irisFormula, trainData, family = binomial(link="probit"))
