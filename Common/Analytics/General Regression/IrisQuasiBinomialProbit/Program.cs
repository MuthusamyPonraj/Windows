...
namespace IrisQuasibinomialProbit
{
    /// <summary>
    ...
    public class Program
    {
        ...
        private void InitializeTable(int rowCount, string predictedfield, string[] predictedCategories)
        {
            ...
            //outputTable.ColumnNames[1] = "NonVersicolorProbability";
            //outputTable.ColumnNames[2] = "VersicolorProbability";
        }
        ...
        public object GetDataObject(Table inputTable, int row)
        {
            var iris = new
            {
                Sepal_Length = inputTable[row, "Sepal_Length"],
                Sepal_Width = inputTable[row, "Sepal_Width"],
                Petal_Length = inputTable[row, "Petal_Length"],
                Petal_Width = inputTable[row, "Petal_Width"],
                Species = inputTable[row, "Species"]
            };
            return iris;
        }
