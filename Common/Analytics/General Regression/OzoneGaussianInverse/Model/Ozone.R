...
# Applying General Regression Model - inverse function to predict Average_ozone_reading
ozoneFormula = formula(average_ozone_reading~.)
ozone_GLM = glm(ozoneFormula, trainData, family = gaussian(link="inverse"))
summary(ozone_GLM)
