...
colnames(ozone) <- c("Month","Day_of_month","Day_of_week","average_ozone_reading","pressure_height","Wind_speed",
"Humidity","Temperature_at_Sandburg","Temperature_at_El_Monte","Inversion_base_height",
"Pressure_gradient","Inversion_base_temperature","Visibility")
...
ozone_RF<-randomForest(average_ozone_reading~.,data=trainData,ntree=50)
ozone_RF
...
colnames(ozoneOriginal) <- c("Month","Day_of_month","Day_of_week","average_ozone_reading","pressure_height","Wind_speed",
"Humidity","Temperature_at_Sandburg","Temperature_at_El_Monte","Inversion_base_height",
"Pressure_gradient","Inversion_base_temperature","Visibility")
