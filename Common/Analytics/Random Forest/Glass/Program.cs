...
namespace GlassRandomForest
{
    ...
    public class Program
    {
        ...
        private void InitializeTable(int rowCount, string predictedfield, string[] predictedCategories)
        {
            ...
            outputTable.ColumnNames[1] = "WindowFloatGlassTypeProbability";
            outputTable.ColumnNames[2] = "WindowNon-floatGlassTypeProbability";
            outputTable.ColumnNames[3] = "VehicleWindowGlassTypeProbability";
            outputTable.ColumnNames[4] = "ContainersTypeProbability";
            outputTable.ColumnNames[5] = "TablewareTypeProbability";
            outputTable.ColumnNames[6] = "VehicleHeadlampsTypeProbability";
        }
        ...
        public object GetDataObject(Table inputTable, int row)
        {
            var glass = new
            {
                RI = inputTable[row, "RI"],
                Na = inputTable[row, "Na"],
                Mg = inputTable[row, "Mg"],
                Al = inputTable[row, "Al"],
                Si = inputTable[row, "Si"],
                K = inputTable[row, "K"],
                Ca = inputTable[row, "Ca"],
                Ba = inputTable[row, "Ba"],
                Fe = inputTable[row, "Fe"],
