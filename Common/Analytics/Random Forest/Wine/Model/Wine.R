...
# PMML generation
pmmlFile<-pmml(wine_RF,data=trainData)
...
wineEntirePrediction<-predict(wine_RF,wineOriginal)

# Predict probability value for entire dataset
Predicted_probabilities<-predict(wine_RF,wineOriginal,type="prob")
