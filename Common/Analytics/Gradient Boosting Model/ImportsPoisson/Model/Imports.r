...
#Use 'r2pmml' package version v0.3.0 or below since, the function 'poisson' has been deprecated in later versions. 
...
# Applying GBM - poisson function to predict censlink functions
imports_GBM =  gbm(price~ symboling+normalizedLosses+fuelType+aspiration+
        ...
        peakRpm+cityMpg+highwayMpg,data=trainData, distribution="poisson")
...
importsEntireProbabilities = predict.gbm(imports_GBM, importsOriginal, n.trees=100,type="link")
